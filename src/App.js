...
function Routes() {
  ...
  if (
    ['/login', '/forgotpassword', '/signupconfirm', '/loginconfirm'].includes(
  ...
  return (
    <Fragment>
      <Router>
        ...
        {!(cacheState.continueAsGuest || commands.user.isLoggedIn()) &&
          showPopup && (
      ...
      /> */}
          ...
          <Route
            exact
            path="/signupconfirm"
            component={screens.SignUpConfirm}
          />
...
function App() {
  ...
  const [homeProductsAvailable, setHomeProductsAvailable] = useState();
  const [bannersAvailable, setBannersAvailable] = useState();
