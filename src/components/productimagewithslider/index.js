        ...
        <div class="sp-inner-content-wrap sp-image-vert-slider vertical-slider">
          ...
          >
            {props.images.map((item, idx) => (
              <div
                key={idx}
                class="vert-slider-item my-1 d-flex align-items-center justify-content-center"
        ...
        <div class="pop sp-inner-content-wrap sp-image-vert-slider horizontal-slider">
          ...
          >
            {props.images.map((item, idx) => (
              <div
                key={idx}
                class="vert-slider-item m-2 d-flex align-items-center justify-content-center"
                onClick={() => props.setCurrentImage(item.image)}
              >
                <img
                  src={item.image || 'null' || require('./images/P860_2.png')}
