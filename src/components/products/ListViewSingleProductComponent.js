...
import './css/listview.scoped.css';
    ...
    if (state.guest_user) {
      ...
      getProducts(
        ...
        .then((res) => {
          ...
          if (!isEqual(props.paginationData, res.data?.meta?.pagination)) {
            ...
            return (
              <Fragment>
                {!(
                  ...
                  <Col xs={12} className="cm-xxl-3 cm-col-prdt-col">
                    <div
                      className="product yt-sgl-product-cpnt text-center mb-4"
                      ...
                      <Row className="list-container">
                        ...
                        <Col xs={8}>
                          <div className="mid-content">
                            <div
                              className="mt-2 yt-sgl-product-title text-left w3-ripple"
                              onClick={() => productDetails(product)}
                            >
                              {product.name}
                            </div>
                            ...
                            <div
                              className="price yt-sgl-price-wrap  text-left pt-2 "
                              onClick={() => productDetails(product)}
                            >
                            ...
                            product.current_availability === 'in_stock' ? (
                              <Fragment>
                                {product.is_in_cart && (
                                  <Ripple
                                    className={
                                      'w-100 cm-overflow-auto cm-bdr-rad-prdt-btn'
                                    }
                                  >
                                    <Button
                                      color="secondary yt-sgl-product-add-btn buttoncart py-3 pshkr"
                  ...
                  (value, idx) =>
                    value.is_master && (
                      <Col
                        key={index + ' ' + idx}
                        xs={12}
                        className="cm-xxl-3 cm-col-prdt-col"
                      >
                        <div
                          className="product yt-sgl-product-cpnt text-center mb-4"
                          style={{ cursor: 'default' }}
                              ...
                              <div className="mid-content">
                                ...
                                >
                                  ...
                                  {value.on_sale && (
                                    <span className="price2 yt-sgl-product-reg-price2">
                                      <del>
                                        {config.currency} {value.actual_price}
                                      </del>
                                    </span>
                                  )}
                                </div>
                              ...
                              <div className="d-flex justify-content-between align-items-center mt-3">
                                {value.on_sale ? (
                                  <div className="yt-sgl-product-off text-center p-1">
                                    -
                                    {parseInt(
                                      ((value.actual_price - value.sale_price) /
                                        value.actual_price) *
                                        100
                                    )}
                                    %
