                ...
                {!(
                  ...
                  <Col md={4} className="cm-xxl-3 cm-col-prdt-col">
                    ...
                    >
                      ...
                      <div
                        className="mt-2 yt-sgl-product-title ellises text-left w3-ripple px-4"
                        onClick={() => productDetails(product)}
                        title={product.name}
                      >
                        {product.name}
                      ...
                      <div
                        className="price yt-sgl-price-wrap  text-left pt-2 px-4"
                        onClick={() => productDetails(product)}
                      >
                    ...
                    value.is_master && (
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className="yt-sgl-product-title mt-2 px-4 text-left w3-ripple ellises"
                            onClick={() => productDetails(product)}
                            title={product.name}
                          >
                            {product.name}
