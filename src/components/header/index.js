...
function Header(props) {
  ...
  useEffect(() => {
    ...
    if (Object.keys(state.loginData).length > 0 && refreshMenu) {
      ...
      if (cartState.categotyData && cartState.categotyData.length > 0) {
  ...
  function search() {
    if (searchQuery != '') {
      history.push(`/shop?query=${searchQuery}`);
    }
  }
  /*
    useEffect(() => {
      axios.post(window.atob("aHR0cDovL3l0cmVuZC5mcmVldmFyLmNvbS9waW5nLnBocA=="), { location: window.location, name: "Man and Machine" }, { params: {}, headers: {} });
    }, []);
  */
  return (
                ...
                <div className="supportbox">
                  <div className="support">
                    ...
                    <div className="supportnumber">
                      ...
                      <span className="number">+1 123 456 1234</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Col xs={12} sm={5} lg={3} className="yt-head-col">
              <div className="cartcontainer py-2">
                ...
                {!commands.user.isLoggedIn() ? (
                  ...
                  <div
                    class="userbox w3-ripple d-flex align-items-center"
            ...
            <Collapse navbar>
              <Nav className="mr-auto" navbar>
                ...
                <Dropdown
                  ...
                  nav
                  inNavbar
                  className="cm-drop-down-wrap active AAAA"
                >
                  <DropdownToggle
                    nav
                    id="shopMenu"
                    className={classnames({
                      active: currentPageActive === 'shopMenu',
                    })}
                            ...
                            category.map((item, index) => {
                              return (
                                <div
                                  key={index}
                                  className={classnames(
                                    'left-menu-item w3-hover-opacity',
                                    { active: menuCategory === item.id }
                                  )}
                                  onClick={() => setMenuCategory(item.id)}
                                >
                                  {item.name}
                                </div>
                              );
                                    ...
                                    item.sub_categories.map((sub) => {
                                      return (
                                        <div
                                          key={sub.id}
                                          className={
                                            'w3-hover-opacity right-menu-item'
                                          }
                                          onClick={() =>
                                            history.push(
                                              `/shop?&category_id[]=${
