...
function OrderDetailsPage(props) {
  ...
  useEffect(() => {
    ...
    console.log(
      'tracking details :',
      trackingDetails?.tracking_detail,
      orderItem
    );
  }, [props]);
  ...
  const data = {
    currency:
      typeof orderItem.total_price_with_currency === 'string' &&
      orderItem.total_price_with_currency.split(' ')[0],
    totalAmount: orderItem.is_default_currency
      ? orderItem.total_price
      : orderItem.total_price_with_currency?.split(' ')[1],
    /*
            ...
            <div class="order-details-main-wrapper bg-white radius-10 mt-3 hc-mb-80">
              ...
              <div className="py-3 d-flex align-items-center mb-3 od-single-prd-details-wrap">
                <span
                  ...
                  style={{ cursor: 'pointer' }}
                >
                  <div class="od-product-img p-1 d-flex align-items-center justify-content-center">
                    <img src={getImageUrl()} class="img-fluid" />
                  </div>
                  <div class="d-flex align-items-center">
                    <div class="order-product-info ">
                      <h2 class="pp-order-product-ttl mt-0">
                        {orderItem.product_name}
                      </h2>

                      <div className="product-id">
                        Product Code: 
                        {trackingDetails?.order_item_detail?.product.system_sku}
                      </div>
                  ...
                  <div class="order-product-quanity text-center text-sm-right">
                    <ul class="p-0 order-ul-list-none m-0 ">
                      <li class="op-order-quantity mb-3">
                        ...
                        <span class="ord-product-quantity">
                          {orderItem.quantity}
                        </span>
                      </li>
                    </ul>
                ...
                <Col md={12}>
                  <div className="order-details-shipping-barmy-3">
                    ...
                    <div className="order-shipping-address-wrap">
                      <h2 class="order-details-address-type">
