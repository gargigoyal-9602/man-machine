                      ...
                      <div class="product profile-pg-wl-sgl-product-cpnt text-center mb-4">
                        <div class="d-flex justify-content-between align-items-center mt-3">
                          {product.on_sale && false ? (
                            <div class="profile-yt-sgl-product-off text-center p-1">
                              Sale
                            </div>
                          ) : (
                        ...
                        >
                          ...
                          <div class="mt-2 profile-pg-wl-sgl-product-title text-left px-4 pb-0 mb-0">
                            {product.name}
                          </div>
                          <div className="yt-product-code text-left px-4 py-2">
                      ...
                      >
                        <div class="product profile-pg-wl-sgl-product-cpnt text-center mb-4">
                          ...
                          >
                            ...
                            <div className="yt-product-code text-left px-4 py-2">
                              Product Code: {value.system_sku}
                            </div>
                            <div className="price profile-pg-wl-sgl-price-wrap text-left px-4 mb-3">
                              {value.on_sale && (
                                <>
                                  <span className="price1 profile-pg-wl-sgl-product-sale-price">
                                    {config.currency} {value.sale_price}
                                  </span>
                                  <span className="price2 profile-pg-wl-sgl-product-reg-price2">
