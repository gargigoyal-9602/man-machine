      ...
      <Container>
        <Row>
          <Col md={12}>
            <div class="pageroute profile-pg-breadcrumbs my-3">
              <Link to="/">
                <span
                  class="profile-pg-home w3-hover-opacity w3-ripple"
        ...
        <Row className="justify-content-center yt-cp-cm-row">
          <Col sm={12} md={12} className="yt-cm-cp-col">
            <div
              class="cp-backfrom-ct-page d-flex align-items-center hc-mb-30"
              onClick={() => {
                routeToProfile();
              }}
              style={{ cursor: 'pointer' }}
            >
              <FaLongArrowAltLeft className="hcp-cp-back-arrow" />{' '}
                    ...
                    <Fragment>
                      ...
                      >
                        <FormGroup>
                          <div
                            class={
                              'profile-change-pass-field fields-active' +
