    ...
    <>
      {Array.isArray(userAddress) && userAddress.length > 0 ? (
        <div class="">
          ...
          <AllModal
            userData={state}
            modalName="DefaultAddress"
            isOpen={showDefaultAddressModal}
            toggle={() => setDefaultAddressmModal(!showDefaultAddressModal)}
          />
                ...
                {userAddress.map((x) => {
                  return (
                    ...
                    >
                      {x.checked}
                      <div
                        class="profile-pg-address-list bg-white radius-10 profile-pg-mb-30"
                        ...
                        <div className="d-flex flex-wrap align-items-center">
                          <div class="pp-sa-img-wrap d-flex">
                            ...
                            <div class="pp-sa-info-wrap pr-5">
                              <h2 class="pp-sa-type mt-0">
                                {/*x.address_type*/ capitalize(x.name)}
                              </h2>
                              <p
                                class="pp-sa-address mb-0"
