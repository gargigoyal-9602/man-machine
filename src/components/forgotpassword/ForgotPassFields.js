    ...
    <div className="yt-fp-wrap">
      {otpToken == '' ? (
        <Link to="/login" className="d-flex">
          ...
          <h3 className="yt-fp-top-back-tag-name">
            {lang.get('forgotPassword', 'Forgot Password ?')}
          </h3>
        </Link>
      ) : (
        <div className="d-flex">
          <h3 className="yt-fp-top-back-tag-name">
            {newpasslang.get('createNewPassword', 'Create New Password')}
          </h3>
        </div>
      )}
      ...
      <h2 className="yt-fp-tag-line-2">
        {otpToken == '' ? (
          <span>
            {emailError == 'success'
              ? lang.get('OTPSent', 'OTP has been sent to your email id.')
              : lang.get(
                  'registeredEmail',
